  ...
  #Javier Gonzalez
    ...
    try {
        ...
        if (!isset($_POST) || empty($_POST)) {
            ...
            $customerNumberArray=obtenerClientesNum($conn);
?>
        <h1 class="text-center"> CONSULTA DE PEDIDOS </h1>
            <form id="product-form" name="formulario" action="03-pe_consped.php" method="post" class="card-body">
...
<?php
                ...
                getInfoPedidoCliente($conn, $customerNumber);
